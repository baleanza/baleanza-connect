  ...
  while (hasMore && page < MAX_PAGES) {
    try {
      const res = await fetch(`${WIX_API_BASE}/stores/v1/products/query`, {
        ...
        headers: getHeaders(),
        body: JSON.stringify({
          // Явне включення варіантів
          includeVariants: true, 
          query: {
            limit: limit,
            skip: skip,
            // Запитуємо всі потрібні поля
