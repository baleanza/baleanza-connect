// lib/wixClient.js (Оновлений файл)
import fetch from 'node-fetch';
import { requireEnv } from './sheetsClient.js'; // Використовуємо імпортовану requireEnv
...
// Функція повинна бути тут, щоб її бачили інші експортовані функції
