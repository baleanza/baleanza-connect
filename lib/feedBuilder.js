...
export function buildOffersXml(importValues, controlValues) {
  ...
  console.log('CONTROL_MAP_DEBUG', JSON.stringify(controlMap, null, 2));
  ...
  rows.forEach((row, rowIndex) => {
    ...
    console.log('ROW_DEBUG', rowIndex + 2, row);
    ...
    headers.forEach((header, colIndex) => {
      ...
      console.log('CELL_DEBUG', headerKey, '=>', xmlName, 'value:', cellValue);
